...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        if (args.Length > 0 && args[0] == "-RegisterProcessAsComServer")
        {
            ...
            ChangeAudioDeviceCommandPalleteExtension extensionInstance = new(extensionDisposedEvent);
            server.RegisterClass<ChangeAudioDeviceCommandPalleteExtension, IExtension>(() => extensionInstance);
            server.Start();
